...
namespace Unity.Labs.FacialRemote
{
    public static class BlendShapeUtils
    {
        ...
        {
            BlendShapeLocation.BrowDownLeft.ToString(),
            BlendShapeLocation.BrowDownRight.ToString(),
            BlendShapeLocation.BrowInnerUp.ToString(),
            BlendShapeLocation.BrowOuterUpLeft.ToString(),
            BlendShapeLocation.BrowOuterUpRight.ToString(),
            BlendShapeLocation.CheekPuff.ToString(),
            BlendShapeLocation.CheekSquintLeft.ToString(),
            BlendShapeLocation.CheekSquintRight.ToString(),
            BlendShapeLocation.EyeBlinkLeft.ToString(),
            BlendShapeLocation.EyeBlinkRight.ToString(),
            BlendShapeLocation.EyeLookDownLeft.ToString(),
            BlendShapeLocation.EyeLookDownRight.ToString(),
            BlendShapeLocation.EyeLookInLeft.ToString(),
            BlendShapeLocation.EyeLookInRight.ToString(),
            BlendShapeLocation.EyeLookOutLeft.ToString(),
            BlendShapeLocation.EyeLookOutRight.ToString(),
            BlendShapeLocation.EyeLookUpLeft.ToString(),
            BlendShapeLocation.EyeLookUpRight.ToString(),
            BlendShapeLocation.EyeSquintLeft.ToString(),
            BlendShapeLocation.EyeSquintRight.ToString(),
            BlendShapeLocation.EyeWideLeft.ToString(),
            BlendShapeLocation.EyeWideRight.ToString(),
            BlendShapeLocation.JawForward.ToString(),
            BlendShapeLocation.JawLeft.ToString(),
            BlendShapeLocation.JawOpen.ToString(),
            BlendShapeLocation.JawRight.ToString(),
            BlendShapeLocation.MouthClose.ToString(),
            BlendShapeLocation.MouthDimpleLeft.ToString(),
            BlendShapeLocation.MouthDimpleRight.ToString(),
            BlendShapeLocation.MouthFrownLeft.ToString(),
            BlendShapeLocation.MouthFrownRight.ToString(),
            BlendShapeLocation.MouthFunnel.ToString(),
            BlendShapeLocation.MouthLeft.ToString(),
            BlendShapeLocation.MouthLowerDownLeft.ToString(),
            BlendShapeLocation.MouthLowerDownRight.ToString(),
            BlendShapeLocation.MouthPressLeft.ToString(),
            BlendShapeLocation.MouthPressRight.ToString(),
            BlendShapeLocation.MouthPucker.ToString(),
            BlendShapeLocation.MouthRight.ToString(),
            BlendShapeLocation.MouthRollLower.ToString(),
            BlendShapeLocation.MouthRollUpper.ToString(),
            BlendShapeLocation.MouthShrugLower.ToString(),
            BlendShapeLocation.MouthShrugUpper.ToString(),
            BlendShapeLocation.MouthSmileLeft.ToString(),
            BlendShapeLocation.MouthSmileRight.ToString(),
            BlendShapeLocation.MouthStretchLeft.ToString(),
            BlendShapeLocation.MouthStretchRight.ToString(),
            BlendShapeLocation.MouthUpperUpLeft.ToString(),
            BlendShapeLocation.MouthUpperUpRight.ToString(),
            BlendShapeLocation.NoseSneerLeft.ToString(),
            BlendShapeLocation.NoseSneerRight.ToString(),
            BlendShapeLocation.TongueOut.ToString()
        };
